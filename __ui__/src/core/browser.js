...
var Browser = /** @class */ (function () {
    ...
    Browser.prototype.getPage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var puppeteerPage, uselessTab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        uselessTab = (_a.sent())[0];
                        return [4 /*yield*/, uselessTab.close()];
                    case 4:
                        _a.sent();
                        return [2 /*return*/, new page_1.Page(puppeteerPage)];
                }
            });
        });
    };
